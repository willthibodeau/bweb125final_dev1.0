...
var markers = [ 
		...
		},
		{
			...
			icon: 'img/icon4.png',
				html: {
					content: '<img src="./images/flatiron.jpg" width="75" height="100"><h3>Flat Iron</h3><p>Location 4</p>',
					popup: true
				}
		},
		{
			...
			icon: 'img/icon5.png',
				html: {
					content: '<img src="./images/cats.jpg" width="75" height="100"><h3>Cats</h3><p>Location 5</p>',
					popup: true
				}
		},
